...
function playSound(e) {
  const dataKey = e.type === 'mousedown' || e.type === 'touchstart' ? this.dataset ? this.dataset.key : 65 : e.keyCode;
...
function removeClass(e) {
  const dataKey = e.type === 'mouseup' || e.type === 'touchend' ? this.dataset ? this.dataset.key : 65 : e.keyCode;
